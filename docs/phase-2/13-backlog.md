...
| SPB-203 | Registrar observabilidade minima de matches | P1 | Facilita diagnostico | Implementado localmente com resumo agregado por ciclo do matcher | SPB-201 | logs sem segredos e com contadores | `tests/test_matcher_observability.py` | validar volume de logs apos deploy | M | Sprint 1 |
