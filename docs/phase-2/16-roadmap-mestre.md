...
SPB-254 (correcoes funcionais: chip-x toque, switch teclado) -- CONCLUIDO em 20/08/2026
   ...
   -> SPB-250E (build/deploy controlado do React dist) -- IMPLEMENTADO localmente, aguardando review/publish
...
- SPB-269;
- Fase E / F / G;
- SPB-250E review remoto/deploy gate;
- SPB-250.
