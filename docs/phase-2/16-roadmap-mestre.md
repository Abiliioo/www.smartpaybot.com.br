...
- SPB-251B reorganiza o dashboard real como fonte de verdade da UX: status de monitoramento, Telegram, plano, uso diario, keywords, oportunidades recentes e proxima melhor acao com dados ja disponiveis. Sem Landing/Pro, sem migracao React e sem deploy nesta etapa.
...
SPB-254 (correcoes funcionais: chip-x toque, switch teclado) -- CONCLUIDO em 20/08/2026
   ...
   -> SPB-251 (dashboard real: status, uso, keywords, oportunidades e proxima acao)
