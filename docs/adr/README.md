...
Registro de decisoes arquiteturais propostas para a Fase 2.

| ADR | titulo | status |
|---|---|---|
| [ADR-001](001-caixa-interna-fonte-primaria.md) | Caixa interna como fonte primaria dos alertas | Proposta |
| [ADR-002](002-alerta-e-entrega-por-canal.md) | Separacao entre alerta e entrega por canal | Proposta |
